...
namespace posv2
{
    public class Kotprint
    {
        ...
        public Kotprint(int id, DataTable order, string tbl)
        {
            kotorder = order;
            orderid = id;
            if (tbl != "")
        ...
        public void print(string printer)
        {
            ...
            {
                MessageBox.Show("KOT Printer is invalid.");
            }
        }
        ...
        void pdoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            //header start
            graphics.DrawString("KOT", new Font("Courier New", 18),
            ...
            graphics.DrawString(underLineend, new Font("Courier New", 10),
                     new SolidBrush(Color.Black), startX, startY + Offset);
            //header end
            for (int i = 0; i < kotorder.Rows.Count; i++)
            {
                DataRow dr = kotorder.Rows[i];
                //Item start
                Offset = Offset + 15;
